...
if ($view == null) $view = 'choixTypeLogin.php' ?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("assets/vendor/fonts/fonta esome/css/fontawesome-all.css"); ?>">
</head>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.html">Achat</a>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right connection-dropdown">
                                <li class="connection-list">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="#" class="connection-item"><img src="<?php echo base_url("assets/images/slack.png") ?>../assets/images/slack.png" alt=""> <span>Slack</span></a>
                                        </div>
                                    </div>
                                </li>
                                <li>
