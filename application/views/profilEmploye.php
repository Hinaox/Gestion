              ...
              <?php if ($this->session->userdata('inRH')==true){ ?>
                <div class="card mt-3">
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <a href = "<?php echo site_url("ContratCtrl/index?idEmp=".$emp['idPersonne']); ?>">Etablir un contrat de travail</a>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <a href = "<?php echo site_url("BPController/listeBulletinEmploye?idEmploye=".$emp['idEmploye']."&nom=".$emp['nom']) ?>">Voir son bulletin de paie</a></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
