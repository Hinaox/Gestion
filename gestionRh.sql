...
INSERT INTO `employe` VALUES (28,1,1,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(29,2,2,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(30,3,3,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(32,5,5,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(33,6,6,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(34,7,7,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(35,8,8,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(36,9,9,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(37,10,10,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(38,11,11,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(39,12,12,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(40,13,13,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(41,14,14,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(42,15,15,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(43,16,16,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(44,17,17,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(45,18,18,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(46,19,19,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(47,20,20,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813'),(48,21,21,1,'2012-02-12','940c0f26fd5a30775bb1cbd1f6840398d39bb813');
...
INSERT INTO `historiqueconge` VALUES (33,48,'M3','2022-01-01 00:00:00','2022-01-04 00:00:00',1),(34,38,'M3','2021-12-31 00:00:00','2022-01-04 00:00:00',-1),(35,39,'M3','2022-01-07 00:00:00','2022-01-08 00:00:00',0),(36,38,'M3','2022-01-01 00:00:00','2022-01-06 00:00:00',-1),(37,48,'M3','2022-03-06 00:00:00','2022-03-11 00:00:00',0),(38,48,'M2','2022-03-31 00:00:00','2022-04-09 00:00:00',1);
...
CREATE TABLE `notification` (
  ...
  PRIMARY KEY (`idNotif`),
  KEY `idEmp` (`idEmp`),
  CONSTRAINT `notification_ibfk_1` FOREIGN KEY (`idEmp`) REFERENCES `employe` (`idEmploye`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notification` VALUES (1,'Votre demande ayant ID 33 pour motif M3 débutant le 2022-01-01 00:00:00 et se finissant le 2022-01-04 00:00:00 vient d\'etre acceptée','2021-12-26',48),(2,'Votre demande ayant ID 36 pour motif M3 débutant le 2022-01-01 00:00:00 et se finissant le 2022-01-06 00:00:00 a été refusé','2021-12-26',38);
...
INSERT INTO `offre` VALUES (1,'Controle de Gestion',' Controlleur de compte','uu',25,5,'ww','ww','2021-12-14');
...
--
/*!50003 DROP FUNCTION IF EXISTS `controleDate` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `controleDate`(dateDebut DATETIME ,dateFin DATETIME) RETURNS varchar(100) CHARSET utf8mb4
BEGIN
...
/*!50003 DROP FUNCTION IF EXISTS `countCongeParDeptMoisAnnee` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `countCongeParDeptMoisAnnee`(idDept varchar(10), ladate DATETIME) RETURNS int(11)
BEGIN
    DECLARE val int;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `diminuerConger` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `diminuerConger`(heure int, idEmpl int) RETURNS tinyint(1)
BEGIN
   DECLARE val boolean;
   SET val = (select
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `retraitHeureConge` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `retraitHeureConge`(IN heureRetire int, IN idEmploye int)
BEGIN
    select diminuerConger(heureRetire,idEmploye);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-03-02 13:03:10
